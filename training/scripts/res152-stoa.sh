...
optim='sgd'
cd ..
CUDA_VISIBLE_DEVICES=2,3,1 python main_split.py -a resnet152 /mogu -j 40 --backup_output_dir $path --epochs 90 --lr_interval 30 -b 256\
...
CUDA_VISIBLE_DEVICES=2,3,1 python main_split.py -a resnet152 /mogu -j 50 --backup_output_dir $path --epochs 20\
 ...
 --optim $optim  --rotate --resume $resume_path --large 1000 --iterate 1000
