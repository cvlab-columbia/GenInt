...
if __name__ == '__main__':
    ...
    outdir_comp = outdir/target_category/model.name/layer_key.lower()/est_id/'gif'
    outdir_inst = outdir/target_category/model.name/layer_key.lower()/est_id/'inst'
    outdir_summ = outdir/target_category/model.name/layer_key.lower()/est_id/'summ'

    # outdir_comp = outdir/model.name/layer_key.lower()/est_id/'comp'
    # outdir_comp = outdir/model.name/layer_key.lower()/est_id/'gif'
    ...
    model.set_output_class(target_category)
